  ...
  >
    <div class="mail" style="text-align: center">
      <header>
        <div class="header" style="padding-bottom: 55px; margin: auto">
          <img
            ...
            alt="SVG Image"
            style="box-sizing: border-box; margin-bottom: 20px; max-width: 80%"
          />
          ...
          >
            ...
            <p style="margin: 0; padding: 0">
              Thank you for registering with PortfolioOne! To complete your registration, please use the following OTP code:
            </p>
          </div>
        </div>
      </header>
      ...
      >
        <div style="display: inline-block; margin: auto">
          <div
            ...
            "
          >
       <p style="font-weight: bold;">OTP code : {otp}</p> 
        <p> This code will expire in 5min. If you did not intiate this request, please disregard this email.
        </p></div>
      ...
      <section
        ...
        "
      >
        <h2 style="font-size: 42.21px">Get the PortfolioOne app!</h2>
...
"""
        msg = Message('Your OTP Code For Registration', recipients=[email])
...
def forgotPasswordSendOTP():
    try:
        ...
        existing_user = cursor.fetchone()
        # return jsonify(existing_user[1])
...
<html lang="en">
      ...
      <header>
        <div class="header" style="padding-bottom: 55px; margin: auto">
          ...
          >
            ...
            <p style="margin: 0; padding: 0">
              You recently requested to reset your password for PorfolioOne account. Please use the following OTP code to proceed:
            </p>
          </div>
        </div>
      </header>
 ...
 """
        ...
        msg = Message('Your OTP Code For Resetting Password', recipients=[email])
        # msg.body = f'Your OTP code is: {otp}'
        msg.html = html_content
