...
"""
        ...
        if subscription_data:
            ...
            if end_date and end_date < datetime.datetime.strptime(current_date, '%Y-%m-%d %H:%M:%S'):
                print('enddate existed', end_date)
                result = {
                    'status': 200,
                    'data': {
                ...
                print('enddate NOT existed', end_date)
                ...
                print('subscription true,even though there is not enddate', end_date)
                result = {
                    'status': 200,
                    'data': {
                        'email': user_data['email'],
            ...
            print('users who are not at all clicked on subscribed button')
...
def add_organization():
    try:
        ...
        # Convert organization name to alphanumeric with lowercase letters only
        ...
        # Create the blob container with the organization name
        url = "https://p1data.blob.core.windows.net/{org_container}?restype=container&sv=2022-11-02&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2024-12-31T16:51:13Z&st=2024-03-05T08:51:13Z&spr=https&sig=RAAln%2Fs5o%2FMoiheiNBtO%2BwVTLPV8dnxwjyQ3iy7eRWo%3D".format(org_container=container_name)
        headers = {
            "x-ms-blob-type": "BlockBlob",
            "x-ms-version": "2022-11-02",
            "x-ms-date": "Fri, 04 Mar 2024 12:00:00 GMT"
        }
        ...
        if response.status_code == 201:
            ...
            return jsonify({'error': 'Failed to create blob container', 'status': 500})
